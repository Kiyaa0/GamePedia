            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="flex items-center gap-4">
                        <a href="{{ route('login') }}" class="text-xs font-bold text-gray-400 hover:text-white uppercase tracking-widest transition">Masuk</a>
                        <a href="{{ route('register') }}" class="text-xs font-bold bg-[#E51920] text-white px-4 py-2 hover:bg-red-600 uppercase tracking-widest transition">Daftar</a>
                    </div>
                @endauth
            </div>
