...
<div class="max-w-7xl mx-auto px-8 py-10 text-white">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <button class="px-3 py-1 bg-[#1a1a1a] border border-gray-800 rounded text-gray-400 hover:text-white transition">
            •••
        </button>
    </div>
    ...
    <div class="mt-12">
        <div class="flex gap-8 text-sm font-bold tracking-widest">
            ...
            <div class="text-gray-500 hover:text-white cursor-pointer pb-4 transition">REVIEWS</div>
            <div class="text-gray-500 hover:text-white cursor-pointer pb-4 transition">MEDIA</div>
        </div>
        ...
        <div class="md:col-span-2">
            ...
            <div class="mt-12">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h3 class="text-lg font-bold tracking-widest uppercase">LATEST REVIEWS</h3>
                </div>

                <div class="space-y-4">
                    <div class="flex justify-between items-center border-b border-gray-800 pb-4">
                        <p class="text-gray-400 text-sm italic">"controlnya responsif, world design solid"</p>
                        <span class="text-red-600 font-bold">9</span>
                    </div>
                </div>
            </div>
        </div>
